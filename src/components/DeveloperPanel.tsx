...
export const DeveloperPanel: React.FC<DeveloperPanelProps> = ({
  ...
  return (
    <div className="w-96 bg-slate-900 border-l border-slate-800 text-slate-100 flex flex-col h-screen overflow-hidden shrink-0 z-30 shadow-2xl animate-in slide-in-from-right duration-200">
      {/* Header */}
      ...
      <div className="p-4 grid grid-cols-2 gap-3 shrink-0 border-b border-slate-800 bg-slate-950/20">
      ...
      {/* Tabs */}
      <div className="flex border-b border-slate-800 bg-slate-950/40 p-1.5 shrink-0 text-xs gap-1">
        {[
